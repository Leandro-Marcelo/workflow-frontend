    ...
    return (
        <div className="grid grid-cols-2 mt-20">
            ...
            <main className="p-2 bg-white md:p-20 rounded-r-lg">
                <h1 className="text-gunmetal-700 text-4xl mb-5">
                    Inicia sesión
                </h1>
                <p className="mb-10 text-gray-400">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Tenetur quos, nam impedit voluptates sequi culpa?
                </p>
                <form className="flex flex-col" onSubmit={iniciarSesion}>
                    ...
                    <input
                        className="outline-none border border-beau-200 p-2 rounded-md focus:border-lavender-800 mb-6"
                        id="email"
                        type="email"
                        name="email"
                    />
                    ...
                    <input
                        className="outline-none border border-beau-200 p-2 rounded-md focus:border-lavender-800 mb-10"
                        id="password"
                        type="password"
                        name="password"
                    />
                    <button className="bg-gunmetal-900 py-2 rounded-md text-white hover:bg-lavender-400 hover:text-lavender-900">
                        Iniciar sesión
                    </button>
                </form>
                ...
                <a
                    className="flex items-center gap-5 justify-center border border-lavender-400 p-2 mt-5 hover:bg-lavender-400"
